...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `rendster`;
    const descriptionValue = description || 'test components';
    const ogTitleValue = ogTitle || title || `rendster`;
    const ogDescriptionValue = ogDescription || description || 'test components';
