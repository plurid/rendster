...
/** CONSTANTS */
const entryIndex = path.resolve(__dirname, '../../../source/services/server/application/client/index.tsx');
const outputPath = path.resolve(__dirname, `../../../${BUILD_DIRECTORY}/application/client`);
